...
type AdminClient interface {
	...
	UsersAdd(ctx context.Context, in *UsersAddRequest, opts ...grpc.CallOption) (*UsersAddResponse, error)
...
func (c *adminClient) UsersAdd(ctx context.Context, in *UsersAddRequest, opts ...grpc.CallOption) (*UsersAddResponse, error) {
	out := new(UsersAddResponse)
	err := c.cc.Invoke(ctx, "/ozon.dev.vldem.hw2.api.Admin/UsersAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	UsersAdd(context.Context, *UsersAddRequest) (*UsersAddResponse, error)
...
func (UnimplementedAdminServer) UsersAdd(context.Context, *UsersAddRequest) (*UsersAddResponse, error) {
...
func _Admin_UsersAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.vldem.hw2.api.Admin/UsersAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).UsersAdd(ctx, req.(*UsersAddRequest))
	}
	return interceptor(ctx, in, info, handler)
}
